...
class TestNotebook(unittest.TestCase):
    ...
    def test_constructor_number_of_unique_values_3(self):
        df = pd.read_csv('tests/test_files/testfile_4.csv', encoding='utf-8',
                         delimiter=';')
        ds = BitmapDataset(1, df)
    ...
    def test_create_bitmap_for_value_1(self):
        df = pd.read_csv('tests/test_files/testfile_3.csv', encoding='utf-8',
                         delimiter=';')
    ...
    def test_find_best_literal_from_variable_1(self):
        df = pd.read_csv('tests/test_files/testfile_4.csv', encoding='utf-8', delimiter=';')
        ds = BitmapDataset(0, df)
